...
export function NotesBrowser({ locale, notes, allLabel, topicLabel }: NotesBrowserProps) {
  ...
  return (
    <section className="space-y-6">
      <FilterBar label={topicLabel} options={topics} value={topic} onChange={setTopic} />
